...
void complexDemo(Object4 &scene)
{
    ...
    // 85+W
    {
        ...
        room8.scale(math::vec4(-1, 1, -1, -1));
        room8.pos = math::vec4(1, 0, 1, 1);
    }
}
